...
public class CrearPacienteViewModel : BaseViewModel
{
    ...
    public CrearPacienteViewModel(PacienteApiService pacienteService, UsuarioApiService usuarioService, LogService logService)
    {
    ...
    private async Task CrearPacienteAsync()
    {
        ...
        if (exito != null)
        {
            ...
            await _logService.RegistrarAccionAsync($"Creó paciente: {nuevo.Nombres} {nuevo.Apellidos}");
